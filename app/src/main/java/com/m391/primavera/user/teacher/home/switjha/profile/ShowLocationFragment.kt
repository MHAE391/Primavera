...
class ShowLocationFragment : BottomSheetDialogFragment(), OnMapReadyCallback {
    private lateinit var dialog: BottomSheetDialog
    private lateinit var behavior: BottomSheetBehavior<View>
    private lateinit var binding: FragmentTeacherLocationBinding
    private lateinit var map: GoogleMap
    private val viewModel: TeacherEditProfileViewModel by activityViewModels()
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        displayLocationOnMap(
            viewModel.teacherInfo.value!!.latitude.toDouble(),
            viewModel.teacherInfo.value!!.longitude.toDouble()
        )
    }
