...
class FatherEditLocationFragment : BottomSheetDialogFragment(), OnMapReadyCallback {
    private lateinit var dialog: BottomSheetDialog
    private lateinit var behavior: BottomSheetBehavior<View>
    private val viewModel: FatherProfileViewModel by activityViewModels()
    private lateinit var map: GoogleMap
    private lateinit var binding: FragmentFatherEditLocationBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_father_edit_location,
            container,
            false
        )
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        setMapClick(map)
        enableMyLocation()
        if (viewModel.newLatitude.value == null && viewModel.newLongitude.value == null) {
            ...
            displayLocationOnMap(
                viewModel.newLatitude.value!!.toDouble(),
                viewModel.newLongitude.value!!.toDouble()
            )
        }
