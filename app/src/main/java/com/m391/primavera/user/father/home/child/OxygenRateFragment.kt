...
import com.m391.primavera.databinding.FragmentOxygenRateBinding
...
class OxygenRateFragment : BaseBottomSheetFragment() {
    private lateinit var dialog: BottomSheetDialog
    private lateinit var behavior: BottomSheetBehavior<View>
    private val healthHistoryViewModel: HealthHistoryViewModel by activityViewModels()
    private lateinit var binding: FragmentOxygenRateBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_oxygen_rate, container, false)
    ...
    override fun onStart() {
        ...
        binding.arrowBtn.setOnClickListener {
            this@OxygenRateFragment.dismiss()
        }
    }
    ...
    override fun onResume() {
        ...
        lifecycleScope.launch {
            healthHistoryViewModel.openOxygenLevelHistoryStream(
    ...
    override fun onPause() {
        super.onPause()
        lifecycleScope.launch {
            healthHistoryViewModel.closeOxygenLevelHistoryStream(
                viewModel.currentChildInformation.value!!.watchUID,
                viewLifecycleOwner
            )
        }
