...
import com.m391.primavera.databinding.FragmentStepsHistoryBinding
...
class StepsHistoryFragment : BaseBottomSheetFragment() {
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_steps_history, container, false)
    ...
    override fun onStart() {
        ...
        binding.arrowBtn.setOnClickListener {
            this@StepsHistoryFragment.dismiss()
        }
    }
    ...
    override fun onResume() {
        ...
        lifecycleScope.launch {
            healthHistoryViewModel.openStepsHistoryStream(
