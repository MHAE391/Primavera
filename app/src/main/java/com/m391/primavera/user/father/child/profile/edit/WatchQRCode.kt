...
class WatchQRCode : BottomSheetDialogFragment() {
    ...
    private val viewModel: EditChildProfileViewModel by activityViewModels()
    ...
    private fun requestPermission() {
        PermissionX.init(this@WatchQRCode).permissions(Manifest.permission.CAMERA)
    ...
    private val barcodeCallback = object : BarcodeCallback {
        override fun barcodeResult(result: BarcodeResult?) {
            viewModel.childNewWatch.value = result!!.text
            dismiss()
        }
